...
export default defineConfig({
  ...
  projects: [
    ...
    { name: 'phone', testMatch: /(tour|interrupt|journal|blocknote|palette|north|north-line|kitchen|shifts|night-hours)\.e2e\.ts/, use: { ...devices['iPhone 13'], defaultBrowserType: 'chromium', hasTouch: true } },
  ],
  webServer: {
