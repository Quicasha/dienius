...
<p align="center"><sub>Every image is generated by <code>npm run shots</code> from the sample fortnight, with the clock pinned to the same Wednesday afternoon.</sub></p>
