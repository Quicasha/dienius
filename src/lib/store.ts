...
export const actions = {
  ...
  // --- the backlog: decided, undated, pulled from ---------------------------
  //
  // Four shelves now, and this one earns its place by being the only one that
  // holds a decision without a date. See the doc comment on `BacklogItem`:
  // nothing here records or shows how long something has been sitting, order
  // is priority, and the day view never mentions it.
