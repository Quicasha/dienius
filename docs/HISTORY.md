# How Dienius got here

The version-by-version record, moved out of [`STATE.md`](STATE.md) in the
freeze preparation (2026-09-24), so that STATE says what the app is now and
this says how it got here. Every section was written when its version was
done, so the code, the files and the screens it names are the ones of that
time, and some are gone since; a section number in it ("section 4",
"section 6") is STATE's as it was then. Nothing here describes the app as it
is today: for that, read STATE, and for why things are the way they are,
...
- [The versions before, one line each](#the-versions-before-one-line-each),
  v1.0 to v2.17
- [The waves, v2.0 to v2.17](#the-waves-v20-to-v217), as STATE's open work
  told them, then [what was asked for](#asked-for-as-the-list-stood-before-the-freeze)
  and [the debts that were paid](#resolved-debts-so-you-do-not-chase-them)
- [The phone checklist, as walked in v2.1](#the-phone-checklist-as-walked-in-v21)
...
## The versions before, one line each
...
## The waves, v2.0 to v2.17

What follows was STATE's section 4, "Open work", as each wave left it:
the newest wave first, each with its table, stage by stage or commit by
commit.
...
### Asked for, as the list stood before the freeze
...
## The phone checklist, as walked in v2.1
...
## Where steps lived, before they were removed
...
v2.13 wave above. Nothing in this list is still in the app; it is here
