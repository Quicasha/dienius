...
tail (DESIGN.md, rule 5; DECISIONS "A row stays a row"). Rule 5 finds
nothing at either size - 181 rows wrapped before it, the task's meta line
and the quick-add on every phone screen among them. 488 findings are left
