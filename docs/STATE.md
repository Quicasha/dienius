...
- **4. Speed and the keyboard: done.** docs/SPEED.md has the numbers and
  ...
  CONVENTIONS 22) and the time field's arrows (a smaller target the field
  itself stands in for). Two names Lighthouse found not holding the words
