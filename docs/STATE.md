...
| **Review** | Week and month facts, all derived from the days themselves: done over planned, deep work, key tasks, two charts, the goals' ages, what was read. No streak since v2.7 |
